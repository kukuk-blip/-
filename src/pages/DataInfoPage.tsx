...
const PROVINCE_SOURCES: DataSource[] = [
  { name: "河南省教育考试院", url: "http://www.haeea.cn/", coverage: "报名人数、选科统计、一分一段、投档线", level: "L1", updateFreq: "高考后分3次" },
  { name: "河北省教育考试院", url: "http://www.hebeea.edu.cn/", coverage: "物理 / 历史类选科人数、本科投档", level: "L1", updateFreq: "录取期间" },
  ...
  { name: "湖南省教育考试院", url: "http://jyt.hunan.gov.cn/jyt/sjyt/hnsjyksy/", coverage: "科目报考人数、位次统计", level: "L1", updateFreq: "录取期间" },
  ...
  { name: "天津市招考资讯网", url: "http://www.zhaokao.net/", coverage: "录取统计、招生计划、等级考", level: "L1", updateFreq: "录取期间" },
  { name: "重庆市教育考试院", url: "https://www.cqksy.cn/", coverage: "新高考选科数据、一分一段", level: "L1", updateFreq: "录取期间" },
  { name: "辽宁省招生考试之窗", url: "http://www.lnzsks.com/", coverage: "3+1+2 选科报名数据、位次表", level: "L1", updateFreq: "录取期间" },
  { name: "江西省教育考试院", url: "http://www.jxeea.cn/", coverage: "报考人数、各批次招生计划", level: "L1", updateFreq: "录取期间" },
  { name: "山西省招生考试网", url: "http://www.sxkszx.cn/", coverage: "高考报名总量、批次录取统计", level: "L1", updateFreq: "录取期间" },
  { name: "广西招生考试院", url: "https://www.gxeea.cn/", coverage: "历年报考人数、院校录取分数线", level: "L1", updateFreq: "录取期间" },
  { name: "陕西省教育考试院", url: "http://www.sneac.com/", coverage: "报考人数、本科专科录取数据", level: "L1", updateFreq: "录取期间" },
  ...
  { name: "吉林省教育考试院", url: "http://www.jleea.edu.cn/", coverage: "招生计划汇总、录取分数线", level: "L1", updateFreq: "录取期间" },
  ...
  { name: "新疆教育考试院", url: "http://www.xjzk.gov.cn/", coverage: "高考报名人数、各批次投档", level: "L1", updateFreq: "录取期间" },
  { name: "宁夏教育考试院", url: "https://www.nxjyks.cn/", coverage: "选科报名数据、录取统计", level: "L1", updateFreq: "录取期间" },
  { name: "青海省教育考试网", url: "http://www.qhksy.org/", coverage: "全省报考人数、招生计划", level: "L1", updateFreq: "录取期间" },
  { name: "西藏教育考试院", url: "http://zsks.xizang.gov.cn/", coverage: "全区报考统计、录取公示", level: "L1", updateFreq: "录取期间" },
];
...
const SUPPLEMENT_SOURCES: DataSource[] = [
  ...
  },
  {
    ...
    url: "http://www.moe.gov.cn/jyb_sjzl/",
